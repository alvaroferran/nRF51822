...
// BNO055 Page 0
#define BNO055_CHIP_ID          0x00    // Return value should be 0xA0
#define BNO055_ACC_ID           0x01    // Return value should be 0xFB
#define BNO055_MAG_ID           0x02    // Return value should be 0x32
#define BNO055_GYRO_ID          0x03    // Return value should be 0x0F
...
static void BNO055_writeByte(uint8_t, uint8_t);
static void BNO055_readBytes(uint8_t, uint8_t, uint8_t *);



typedef struct {
  	int16_t intD0, intD1, intD2, intD3;
  	double d0, d1, d2, d3;
}BNO055_data ;

BNO055_data dataBNO055;
